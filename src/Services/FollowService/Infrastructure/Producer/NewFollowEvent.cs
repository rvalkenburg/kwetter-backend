...
{
    public class NewFollowEvent : IDisposable, INewFollowEvent
    {
        private readonly IProducer<string, string> _producer;
        private readonly string _topic;

        public NewFollowEvent(IProducer<string, string> producer, string topic)
        {
            _producer = producer;
            _topic = topic;
        }

        public Object SendNewFollowEvent(FollowEvent followEvent)
        {
